  ...
  function renderPaper() {
    ...
    if (id === 'agreement-v2') {
      body = `<div class="paper-running-head"><span>Harbour House Review</span><span>AGREEMENT / 04</span></div>
        <span class="document-section-label">Service agreement</span><h1>${title}<br><em>Digital experience delivery</em></h1>
      ...
      body = `<div class="paper-running-head"><span>Harbour House Review</span><span>AGREEMENT / 04</span></div>
        <span class="document-section-label">Service agreement · archived</span><h1>${title}<br><em>Digital experience delivery</em></h1>
